...
const typeBadgeColors: Record<string, string> = {
  Kost: "bg-blue-100 text-blue-700 dark:bg-blue-500/20 dark:text-blue-200",
  Ruko: "bg-orange-100 text-orange-700 dark:bg-orange-500/20 dark:text-orange-200",
  Kontrakan: "bg-green-100 text-green-700 dark:bg-green-500/20 dark:text-green-200",
  Villa: "bg-purple-100 text-purple-700 dark:bg-purple-500/20 dark:text-purple-200",
}
...
export function PropertyCard({ property, t, unlocked, onUnlock }: PropertyCardProps) {
  return (
    <div className="bg-card rounded-2xl border border-border/70 overflow-hidden shadow-sm hover:shadow-lg transition-all hover:-translate-y-0.5 group ring-1 ring-transparent hover:ring-primary/10">
      {/* Image */}
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-3 left-3 flex gap-2">
          ...
          {property.featured && (
            <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-amber-100 text-amber-800 dark:bg-amber-500/20 dark:text-amber-200 flex items-center gap-1">
      ...
      <div className="p-4 flex flex-col">
        <h3 className="font-semibold text-sm text-foreground leading-snug line-clamp-2 mb-2 min-h-[2.75rem]">
          {property.title}
        </h3>
        ...
        {/* Facilities */}
        <div className="flex flex-wrap gap-1.5 mb-4 min-h-[3.25rem] content-start">
        ...
        <div
          className={cn(
            "flex flex-col gap-3 pt-3 border-t border-border mt-auto"
          )}
        >
          ...
          {unlocked ? (
            ...
            >
              <Button
                size="sm"
                className="w-full bg-accent hover:bg-accent/90 text-accent-foreground text-xs gap-1.5"
              >
            ...
            <Button
              ...
              className="w-full bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-semibold gap-2 px-3.5 shadow-sm whitespace-normal text-center max-w-full [&_svg]:size-3.5"
            >
