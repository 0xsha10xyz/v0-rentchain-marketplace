      ...
      <div className="flex items-center justify-between mb-5 gap-3">
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none text-sm bg-card border border-border rounded-lg pl-3 pr-8 py-2 text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 cursor-pointer"
          >
      ...
      <div className="flex gap-6">
        ...
        {sidebarOpen && (
          <div className="fixed inset-0 z-40 md:hidden">
            ...
            <div className="absolute left-0 top-0 bottom-0 w-80 bg-card p-5 overflow-y-auto shadow-xl">
              <div className="flex items-center justify-between mb-4">
                <h2 className="font-bold text-sm text-foreground">{t.filters}</h2>
